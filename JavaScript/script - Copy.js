...
generateBtn.addEventListener('click', writePassword);
        ...
        // my bugs were: 
// button needs clicking two times before generates,
// need to reload page for popups to work
// still lets you generate password even if you put 7000 for example, it'll tell you it's not right but do it anyways
// and if you don't define characters it'll give you undefined x length specified.
